...
var
  ...
  i, intPosL, intPosPD, intPosWD, intPosRADD, intPosVD, intPosVA, intPosLADD, intPosPR, intPosPL, intPosRV, intPosLV, intPosVisus: Integer;
  R_Line, R_SPH, R_CYL, R_AXIS, R_ADD, R_PD, R_WD, R_VD, R_VA, R_PRISM, R_VISUS, VisusLineFar, VisusLineBase: String;
  L_Line, L_SPH, L_CYL, L_AXIS, L_ADD, L_PD, L_PRISM, L_VISUS, B_VISUS: String;
  bolAddWDValueToOutput, bolAddPDValueToOutput, bolUseStrictMode, bolAddVisusValueToOutput: Boolean;
...
begin
         ...
         begin
          ...
          if (S[2] in ['r', 'l', 'b', 'd', 'v', 'R', 'L', 'B', 'D', 'V']) then
           begin
            ...
            begin              
              if (R_VISUS <> '') or (L_VISUS <> '') then
              begin
                VisusLineFar:= VisusLineFar + 'R:cc=' + Trim(R_VISUS) + ' //L:cc=' + Trim(L_VISUS);
              end;
	            ...
	            if (B_VISUS <> '') then
	            begin
	              VisusLineBase:= VisusLineBase + 'B:cc=' + Trim(B_VISUS);
	            end;
            end;
  ...
  begin
    ...
    ParsedData := ParsedData + FOutputLineSeparator + (FOutputGDTIdentifier + FOutputGDTValueSeparator) + GDT_FID_MEASURE_DATA + FOutputLineSeparator + Trim(R_WD);
  end;
