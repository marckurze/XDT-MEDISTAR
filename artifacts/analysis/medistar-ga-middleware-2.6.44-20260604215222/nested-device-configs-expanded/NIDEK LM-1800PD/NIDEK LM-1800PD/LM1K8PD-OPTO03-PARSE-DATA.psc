...
begin
  ...
  if (R_PRISM <> '') and (R_PRISMBASE <> '') 
  and (bolAddPrismAndBaseToOutput) then
  begin
    if (R_Line <> '') then
    begin
      R_Line:= R_Line + ' ';
  ...
  if (R_PRISMX <> '') and (R_PRISMY <> '') 
  and (bolAddPrismXandYToOutput) then
  begin
    if (R_Line <> '') then
    begin
      R_Line:= R_Line + ' ';
