...
begin
  ...
  // The Visutron 900 plus will accept data input messages from an external computer system in
  ...
  begin
    ...
    begin    
      ...
      DataToSend:= DataToSend + 'ACC  :' + FormatNumberValue(LM_R_A, True) + DATA_LINE_SEPARATOR_01; // Accommodation range (A or ACC) (IGNORED)
  ...
  begin
    ...
    begin
      ...
      DataToSend:= DataToSend + 'ACC_R  :' + FormatNumberValue(LM_R_A, True) + DATA_LINE_SEPARATOR_01; // Accommodation range (A or ACC) (IGNORED)       
      DataToSend:= DataToSend + 'VIS_S_R:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Uncorrected (S.C) visual acuity (IGNORED)
      DataToSend:= DataToSend + 'VIS_C_R:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Corrected (C.C.) visual acuity (IGNORED)   
      ...
      DataToSend:= DataToSend + 'ACC_L  :' + FormatNumberValue(LM_L_A, True) + DATA_LINE_SEPARATOR_01; // Accommodation range (A or ACC) (IGNORED)   
      DataToSend:= DataToSend + 'VIS_S_L:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Uncorrected (S.C) visual acuity (IGNORED)
      DataToSend:= DataToSend + 'VIS_C_L:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Corrected (C.C.) visual acuity (IGNORED)   
      ...
      DataToSend:= DataToSend + 'BLUR   :' + '   0.00' + DATA_LINE_SEPARATOR_01; // Blur point (IGNORED)
      DataToSend:= DataToSend + 'VIS_S_B:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Uncorrected (S.C) binocular visual acuity (IGNORED)
      DataToSend:= DataToSend + 'VIS_C_B:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Corrected (C.C.) binocular visual acuity (IGNORED)
    ...
    begin
      ...
      DataToSend:= DataToSend + 'ACC_R  :' + FormatNumberValue(AR_R_A, True) + DATA_LINE_SEPARATOR_01; // Accommodation range (A or ACC) (IGNORED)       
      DataToSend:= DataToSend + 'VIS_S_R:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Uncorrected (S.C) visual acuity (IGNORED)
      DataToSend:= DataToSend + 'VIS_C_R:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Corrected (C.C.) visual acuity (IGNORED)   
      DataToSend:= DataToSend + 'PD_R   :' + '   0.00' + DATA_LINE_SEPARATOR_01;     
      ...
      DataToSend:= DataToSend + 'ACC_L  :' + FormatNumberValue(AR_L_A, True) + DATA_LINE_SEPARATOR_01; // Accommodation range (A or ACC) (IGNORED)   
      DataToSend:= DataToSend + 'VIS_S_L:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Uncorrected (S.C) visual acuity (IGNORED)
      DataToSend:= DataToSend + 'VIS_C_L:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Corrected (C.C.) visual acuity (IGNORED)   
      DataToSend:= DataToSend + 'PD_L   :' + '   0.00' + DATA_LINE_SEPARATOR_01;        
    ...
    // send all data to the device (Computer -> Visutron 900 Plus)
    if (DataToSend <> '') and (bolRefraktometerDataFound) then
    begin
      DoCOMPSSendData(DataToSend);
    end;
    ...
    begin
      ...
      DataToSend:= DataToSend + 'ACC_R  :' + FormatNumberValue(FN_R_A, True) + DATA_LINE_SEPARATOR_01; // Accommodation range (A or ACC) (IGNORED)       
      DataToSend:= DataToSend + 'VIS_S_R:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Uncorrected (S.C) visual acuity (IGNORED)
      DataToSend:= DataToSend + 'VIS_C_R:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Corrected (C.C.) visual acuity (IGNORED)   
      DataToSend:= DataToSend + 'PD_R   :' + '   0.00' + DATA_LINE_SEPARATOR_01;
      ...
      DataToSend:= DataToSend + 'ACC_L  :' + FormatNumberValue(FN_L_A, True) + DATA_LINE_SEPARATOR_01; // Accommodation range (A or ACC) (IGNORED)   
      DataToSend:= DataToSend + 'VIS_S_L:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Uncorrected (S.C) visual acuity (IGNORED)
      DataToSend:= DataToSend + 'VIS_C_L:' + '   0.00' + DATA_LINE_SEPARATOR_01; // Corrected (C.C.) visual acuity (IGNORED)   
      DataToSend:= DataToSend + 'PD_L   :' + '   0.00' + DATA_LINE_SEPARATOR_01;        
  ...
  // If the reception is correct, an "Acknowledge" (06 Hex) must be sent back,
  // otherwise a "Not Acknowledge" (15 Hex). After acknowledging with "Not
  // Acknowledge" the entire telegram is repeated by the VISUTRON 900+.
  
  // 23-11-2022 FIX: If we don't send any measurement data to the device, 
