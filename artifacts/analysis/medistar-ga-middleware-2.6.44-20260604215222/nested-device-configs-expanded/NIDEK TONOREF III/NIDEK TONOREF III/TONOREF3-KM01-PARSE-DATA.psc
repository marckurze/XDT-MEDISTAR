const
	VERSION = '1.0.2.36';
	DATE = '03.12.2019 10:06:17';
	TEXT = 'Copyright (c) 2019 team2work GmbH';

        // Hier kann die KM Zone ausgewählt werden.
	XPATH_KM_CONDITION = #$CE+#$A6+'2.4mm';
	
	XPATH_EXPRESSION_01 = '//Data/Patient/ID';
	XPATH_EXPRESSION_02 = '//Data/R/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/R1/Radius';
	XPATH_EXPRESSION_03 = '//Data/R/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/R1/Axis';
	XPATH_EXPRESSION_04 = '//Data/R/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/R2/Radius';
	XPATH_EXPRESSION_05 = '//Data/R/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/R2/Axis';
	XPATH_EXPRESSION_06 = '//Data/R/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/Average/Radius';
	XPATH_EXPRESSION_07 = '//Data/R/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/KMCylinder/Power';
	XPATH_EXPRESSION_08 = '//Data/R/KM[@condition='''+XPATH_KM_CONDITION+''']/KMImage';
	XPATH_EXPRESSION_09 = '//Data/L/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/R1/Radius';
	XPATH_EXPRESSION_10 = '//Data/L/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/R1/Axis';
	XPATH_EXPRESSION_11 = '//Data/L/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/R2/Radius';
	XPATH_EXPRESSION_12 = '//Data/L/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/R2/Axis';
	XPATH_EXPRESSION_13 = '//Data/L/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/Average/Radius';
	XPATH_EXPRESSION_14 = '//Data/L/KM[@condition='''+XPATH_KM_CONDITION+''']/KMMedian/KMCylinder/Power';
	XPATH_EXPRESSION_15 = '//Data/L/KM[@condition='''+XPATH_KM_CONDITION+''']/KMImage';
