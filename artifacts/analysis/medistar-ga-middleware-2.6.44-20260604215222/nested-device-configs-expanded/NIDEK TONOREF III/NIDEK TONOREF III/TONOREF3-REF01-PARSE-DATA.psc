...
var
  ...
  VD, R_S, R_Z, R_Axis, R_Image, L_S, L_Z, L_Axis, L_Image, PD: String;
  R_Line, L_Line: String;
  bolAddExternalFilesToGdtFile, bolAddVDValueToOutput, bolAddPDValueToOutput: Boolean;
