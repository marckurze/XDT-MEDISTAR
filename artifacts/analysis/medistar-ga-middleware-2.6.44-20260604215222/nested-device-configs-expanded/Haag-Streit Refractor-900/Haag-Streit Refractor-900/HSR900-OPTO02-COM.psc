...
begin
  ...
  // Der Haag-Streit Refractor 900 verfügt über 2 mögliche Übertragungsprotokolle.
  ...
  // The Haag-Streit Refractor 900 will accept data input messages from an external computer system in
  // order to transfer refraction measurement data from the external system into the Haag-Streit Refractor 900.
  DataToSend:= '';
  ...
  begin
    ...
    // send LM data to the device (Computer -> Haag-Streit Refractor 900)
    ...
    // send all data to the device (Computer -> Haag-Streit Refractor 900)
  ...
  begin
    // A data output message is sent by the Haag-Streit Refractor 900 when
