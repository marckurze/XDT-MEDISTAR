...
var
  ...
  R_PD, L_PD, PD, R_S, R_Z, R_Axis, R_Add, R_Prism_x, R_Prism_y, L_S, L_Z, L_Axis, L_Add, L_Prism_x, L_Prism_y: String;
...
begin
  ...
  begin
    ...
    if (Trim(S1) = LINE_IDENTIFIER_LM) then
     Continue;    
    ...
    if (T2WStartsStr(LINE_IDENTIFIER_PD, Trim(S1))) then
    begin 
      PD:= Copy(S1, 3, 4);
      R_PD:= Copy(S1, 7, 4);
      L_PD:= Copy(S1, 10, 4);
