const
  ...
  TEXT = 'Copyright (c) 2022 team2work GmbH';
	...
	XPATH_EXPRESSION_05 = '//Ophthalmology/*[name()=''nsLM:Measure''][@type=''LM'']/*[name()=''nsLM:LM'']/*[name()=''nsLM:R'']/*[name()=''nsLM:Add1'']';
	XPATH_EXPRESSION_06 = '//Ophthalmology/*[name()=''nsLM:Measure''][@type=''LM'']/*[name()=''nsLM:LM'']/*[name()=''nsLM:R'']/*[name()=''nsLM:Add2'']';
	XPATH_EXPRESSION_07 = '//Ophthalmology/*[name()=''nsLM:Measure''][@type=''LM'']/*[name()=''nsLM:LM'']/*[name()=''nsLM:R'']/*[name()=''nsLM:H''][@Prism=''P'']';
	XPATH_EXPRESSION_08 = '//Ophthalmology/*[name()=''nsLM:Measure''][@type=''LM'']/*[name()=''nsLM:LM'']/*[name()=''nsLM:R'']/*[name()=''nsLM:V''][@Prism=''P'']';
	...
	XPATH_EXPRESSION_12 = '//Ophthalmology/*[name()=''nsLM:Measure''][@type=''LM'']/*[name()=''nsLM:LM'']/*[name()=''nsLM:L'']/*[name()=''nsLM:Add1'']';
	XPATH_EXPRESSION_13 = '//Ophthalmology/*[name()=''nsLM:Measure''][@type=''LM'']/*[name()=''nsLM:LM'']/*[name()=''nsLM:L'']/*[name()=''nsLM:Add2'']';
	XPATH_EXPRESSION_14 = '//Ophthalmology/*[name()=''nsLM:Measure''][@type=''LM'']/*[name()=''nsLM:LM'']/*[name()=''nsLM:L'']/*[name()=''nsLM:H''][@Prism=''P'']';
	XPATH_EXPRESSION_15 = '//Ophthalmology/*[name()=''nsLM:Measure''][@type=''LM'']/*[name()=''nsLM:LM'']/*[name()=''nsLM:L'']/*[name()=''nsLM:V''][@Prism=''P'']';
...
begin
  ...
  if Length(arrData) > 0 then
  begin
    R_S := R_S + 'S=' + FormatPowerValue(arrData[0][2]);
  end;	
  ...
  if Length(arrData) > 0 then
  begin
    R_C := R_C + 'Z=' + FormatPowerValue(arrData[0][2]);
  end;	
  ...
  if Length(arrData) > 0 then
  begin
    R_Prism_H := R_Prism_H + FormatPrismValue(arrData[0][2], GDT_PRISM_PX_POSITIVE_SUBSTITUTE, GDT_PRISM_PX_NEGATIVE_SUBSTITUTE, GDT_PRISM_FILL_UP_BLANK_SPACES);
  end;
  ...
  if Length(arrData) > 0 then
  begin
    R_Prism_V := R_Prism_V + FormatPrismValue(arrData[0][2], GDT_PRISM_PY_POSITIVE_SUBSTITUTE, GDT_PRISM_PY_NEGATIVE_SUBSTITUTE, GDT_PRISM_FILL_UP_BLANK_SPACES);
  end;
  ...
  if Length(arrData) > 0 then
  begin
    L_S := L_S + 'S=' + FormatPowerValue(arrData[0][2]);
  end;	
  ...
  if Length(arrData) > 0 then
  begin
    L_C := L_C + 'Z=' + FormatPowerValue(arrData[0][2]);
  end;	
  ...
  if Length(arrData) > 0 then
  begin
    L_Prism_H := L_Prism_H + FormatPrismValue(arrData[0][2], GDT_PRISM_PX_POSITIVE_SUBSTITUTE, GDT_PRISM_PX_NEGATIVE_SUBSTITUTE, GDT_PRISM_FILL_UP_BLANK_SPACES);
  end;
  ...
  if Length(arrData) > 0 then
  begin
    L_Prism_V := L_Prism_V + FormatPrismValue(arrData[0][2], GDT_PRISM_PY_POSITIVE_SUBSTITUTE, GDT_PRISM_PY_NEGATIVE_SUBSTITUTE, GDT_PRISM_FILL_UP_BLANK_SPACES);
  end;
