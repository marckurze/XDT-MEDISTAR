...
begin
	...
	R_Add:= T2WStringReplace(R_Add, DATA_SEPARATOR_ETB, '', True, False);
	L_Add:= T2WStringReplace(L_Add, DATA_SEPARATOR_ETB, '', True, False);	
	
	R_Prism_x:= T2WStringReplace(R_Prism_x, DATA_SEPARATOR_ETB, '', True, False);
	R_Prism_y:= T2WStringReplace(R_Prism_y, DATA_SEPARATOR_ETB, '', True, False);
	L_Prism_x:= T2WStringReplace(L_Prism_x, DATA_SEPARATOR_ETB, '', True, False);	
	L_Prism_y:= T2WStringReplace(L_Prism_y, DATA_SEPARATOR_ETB, '', True, False);
