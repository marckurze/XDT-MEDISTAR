const
  ...
  XPATH_EXPRESSION_20 = '//Data/R/VA/UCVA';
  XPATH_EXPRESSION_21 = '//Data/L/VA/UCVA';
  XPATH_EXPRESSION_22 = '//Data/R/SR/ADD';  
  XPATH_EXPRESSION_23 = '//Data/L/SR/ADD';
  XPATH_EXPRESSION_24 = '//Data/R/VA/NVA';
  XPATH_EXPRESSION_25 = '//Data/L/VA/NVA';
...
var
  ...
  VD, R_S, R_Z, R_Axis, R_Image, L_S, L_Z, L_Axis, L_Image, PD, R_CC, L_CC, R_SC, L_SC, Visus_R_CC, Visus_L_CC, Visus_R_CC_Near, Visus_L_CC_Near, Visus_R_NVA, Visus_L_NVA: String;
  R_Line, L_Line, VisusLine: String;
  ...
  bolAddVisusValueToOutput: Boolean; 
...
begin
  ...
  // Verwende "True", damit der Visus Wert (Nah und Fern) als die V Zeile exportiert wird,
 ...
 if Length(arrData) <= 0 then
  ...
  if Length(arrData) > 0 then
  begin   
    Visus_R_CC_Near:= Visus_R_CC_Near + FormatSignValue('', arrData[0][2], bolAddSign, bolAddSignSeparator);
  end;
  ...
  if Length(arrData) > 0 then
  begin   
    Visus_L_CC_Near:= Visus_L_CC_Near + FormatSignValue('', arrData[0][2], bolAddSign, bolAddSignSeparator);
  end;
  ...
  // Add visus (Near)
  if (Visus_R_CC_Near <> '') 
  or (Visus_L_CC_Near <> '') then
  begin
    VisusLine:= '';
    VisusLine:= VisusLine + 'N R:cc=' + Visus_R_CC_Near + ' //' + 'L:cc=' + Visus_L_CC_Near;
    
    if (Visus_R_NVA <> '') 
    or (Visus_L_NVA <> '') then
    begin
      VisusLine:= '';
      VisusLine:= VisusLine + 'N R:cc=' + Visus_R_NVA + ' ' + 'ADD=' + Visus_R_CC_Near + ' //' + 'L:cc=' + Visus_L_NVA + ' ' + 'ADD=' + Visus_L_CC_Near;
    end;
