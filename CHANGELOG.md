...
- TOPCON CV-5000 / CV-5000S als ersten bidirektionalen Phoropter-Kandidaten ergaenzt: MEDISTAR-Historienparser fuer Karteikartenzeilen, CV-5000-Import-XML-Writer, CV-5000-Rueckgabeparser, `6228`-Phoropter-Rueckgabe, BuiltIn-Geraete-/Export-/Schnittstellenprofil, optionale UI-Konfiguration `Ausgabefunktionen an Geraet verwenden` und selektiver Templatepaket-Test. Die praktische MEDISTAR-/CV-5000-Livevalidierung steht noch aus.
