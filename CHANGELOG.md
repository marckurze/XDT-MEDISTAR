...
- `InterfaceProfileActivationExecutorStub` bereitet finale Re-Evaluation als nicht-produktive `ValidateOnly`-Simulation vor: Evaluation, Guard, Warnungsbestaetigung und ActivationPlan koennen optional neu erzeugt werden; fehlen Services, werden MissingCapabilities gemeldet, und Save bleibt DryRun ohne Profilmutation.
