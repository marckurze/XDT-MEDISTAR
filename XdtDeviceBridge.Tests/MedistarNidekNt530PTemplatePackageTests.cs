...
public sealed class MedistarNidekNt530PTemplatePackageTests
{
    private const string DefaultAisProfileId = "ais-medistar-default";
    private const string DefaultDeviceProfileId = "device-nidek-nt530p-default";
    private const string DefaultExportProfileId = "export-medistar-nidek-nt530p-default";
    private const string DefaultInterfaceProfileId = "interface-medistar-nidek-nt530p-default";
    ...
    [Fact]
    public void Export_ShouldContainOnlyNt530PAndDependencies()
    {
        var importResult = _importer.Import(ExportTemplateCandidate());

        Assert.Equal("package-medistar-nidek-nt530p-v1", importResult.Package.Metadata.Id);
        Assert.Equal("MEDISTAR + NIDEK NT530P Templatepaket V1", importResult.Package.Metadata.Name);
    ...
    private static string CreateTempZipPath()
    {
        ...
        return Path.Combine(folder, "medistar-nidek-nt530p-v1.templatepackage.zip");
    }
}
