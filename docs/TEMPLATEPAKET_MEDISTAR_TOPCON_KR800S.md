...
- `6227`: konservative SBJ-Zeilen fuer vorhandene Full-Correction-Fern-/Nahwerte.
...
Subjektive Refraktion Full Correction FAR: R.:S=+ 3.75 Z=- 4.00* 13 VA=0.6 / L.:S=+ 3.75 Z=- 2.50*173 VA=1.0 PD=66 VD=13.75
```
