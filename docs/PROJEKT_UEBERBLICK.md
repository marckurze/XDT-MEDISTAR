...
- NIDEK RT-6100: bidirektionaler LAN-/MEM-200-Phoropter-Kandidat mit PDF-basierter Shared-Folder-/`DIRECT_RT_xx\TXT`-Auswertung, RT-6100-Ophthalmology-Inputwriter fuer `LM_Base`/`REF_Base`, Rueckgabeparser, fachlich getrennter Rueckgabe (`Best` vollstaendig ueber `6228`, `Full` vollstaendig ueber `6227`, keine `6330`-Zeilen), BuiltIn-Profilen, Schnittstellenprofil-Konfiguration fuer Ausgabe an Geraet, selektivem Templatepaket-Test und Protokollnotizen; praktische MEM-200-/Geraete-/MEDISTAR-Abnahme offen
...
- `docs/NIDEK_RT6100_PROTOKOLL_NOTIZEN.md`: Protokollnotizen zur RT-6100-PDF-Auswertung, XML-Struktur, Eingangs-/Rueckgabe-Mapping und malformed OCR-Beispieldatei.
