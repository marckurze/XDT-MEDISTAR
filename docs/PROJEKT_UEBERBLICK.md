...
Naechste sinnvolle Schritte: abdockbare Geraeteanbindungsfenster praktisch mit AR360/ARK1S testen, inklusive Auto-Oeffnung und Signalton bei Monitoring-Aktivitaet, X-Schliessen, Radar, `-`/`+` und Neustart-Wiederherstellung; Release-Regel fuer ARK1S- und AR360-ZIP-Artefakte anwenden, optional den AR360-XDT-Anhangfall separat testen, LM7/LM7P-Dateien validieren, daraus ein fertiges LM7/LM7P-Paket vorbereiten, danach NT530P oder TOPCON-Profile nach Datenlage priorisieren, Aktivierungsassistent vorerst ruhen lassen.
```
