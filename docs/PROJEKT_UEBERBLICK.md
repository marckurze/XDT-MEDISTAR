...
Wichtig: Diese V2-/BuiltIn-Profile sind vorbereitet und konfigurierbar; TOPCON CL300 und TOPCON KR800S sind inzwischen praktisch validiert, und TRK2P bleibt reiner Vorbereitungskandidat.
...
5. Danach NT530P praktisch in MEDISTAR mit korrigierter `6205`/`6220`-Anzeige und JPG-Mehrfachanhaengen validieren; TOPCON CL300 und TOPCON KR800S als praktisch validierte Referenzkandidaten beibehalten, H/V-Prisma sowie weitere SBJ-Funktionstestfaelle beobachten. TRK2P weiter nach Datenlage priorisieren.
