...
Fuer NIDEK RT-2100 / RT-3100 / RT-5100 ist zusaetzlich eine eigene serielle Phoropterfamilie vorbereitet. Sie nutzt die aus den Hersteller-PDFs abgeleiteten Presets 2400 7E2 beziehungsweise 9600 8O1, parst dokumentnahe RT->PC-Frames mit Final-/Subjective-Werten und erzeugt im XDT-Baukasten PC->RT-Sendeframes fuer vorhandene LM-/AR-Historienwerte. Das ist bewusst ein Test-/Vorschaustand; echte Praxis-Mitschnitte und Live-Senden sind noch offen.
...
- NIDEK RT-2100 / RT-3100 / RT-5100 RS232: serielle bidirektionale Phoropterfamilie mit PDF-basierten Type1-/Type2-Presets, gemeinsamem Parser `NidekRtSerialPhoropterParser`, PC->RT-Writer `NidekRtSerialPhoropterOutputWriter`, MEDISTAR-Mapping `Final -> 6228` und `Subjective -> 6227`, BuiltIn-Profilen, Schnittstellenprofil-Konfiguration und Templatepaket-Kandidaten; echte Praxis-Mitschnitte und Live-Senden offen

Wichtig: Diese V2-/BuiltIn-Profile sind vorbereitet und konfigurierbar; TOPCON CL300, TOPCON KR800S, TOPCON TRK2P und TOPCON CT1P sind inzwischen praktisch validiert. Fuer TRK2P ist zusaetzlich die Teilmessungsregel mit einer TM/CCT-only-Datei bestaetigt. TOPCON KR-1 ist testseitig als Keratorefraktometer-Kandidat mit REF-`6228` vorbereitet; KM/KRT bleibt bis zu einer echten Fixture offen. TOPCON CT800A ist testseitig als Non-Contact-Tonometer-Kandidat vorbereitet. TOPCON CV5000, NIDEK RT6100 und NIDEK RT-2100/RT-3100/RT-5100 RS232 sind testseitig als bidirektionale Phoropter-Kandidaten vorbereitet; RT6100 braucht fuer die Praxisabnahme eine echte wohlgeformte Rueckgabedatei, die serielle RT-Familie braucht echte RS232-Mitschnitte.
