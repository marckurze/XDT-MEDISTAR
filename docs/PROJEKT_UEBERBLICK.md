...
TOPCON CV5000 / CV-5000S nutzt als UI-Pilot im Monitoring statt Radar ein Geraetebild mit linkem Infoblock und pulsierender Statuskugel. Die Kugel pulsiert anhand des Scanintervalls und kann bei Dateieingang kurz gruen blitzen. `Letzter Scan` und `Automatik` stehen fuer diesen Pilot nur noch im Detailbereich. Andere Geraete bleiben bewusst beim bisherigen Radar, bis ein spaeterer Rollout entschieden wird.
