...
Fuer Dokumentgeraete ohne Messwerte gibt es den V1-Kandidaten `MEDISTAR + Dokumentanhang`. Er behandelt die Dokumentdateien als reine Anhaenge, kann optional einen Anwendertext ueber `6227` ausgeben und erzeugt keine Messwertfelder wie `6228`, `6205` oder `6220`.
