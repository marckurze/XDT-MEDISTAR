...
5. Danach NT530P praktisch in MEDISTAR mit korrigierter `6205`/`6220`-Anzeige und JPG-Mehrfachanhaengen validieren; TOPCON CL300 als praktisch validierten Referenzkandidaten beibehalten, H/V-Prisma weiter beobachten und KR800/TRK2P weiter nach Datenlage priorisieren.
