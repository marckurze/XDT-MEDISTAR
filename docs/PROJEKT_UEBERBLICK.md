...
Vor einer spaeteren Entfernung des Tabs `Profile & Templates` muessen noch die dortigen reinen Profilpflegefunktionen in eine eigenstaendige Profilverwaltung ueberfuehrt werden: Profiluebersicht, Umbenennen, Loeschen, Geraetebildpflege und einzelne Wartungs-/Diagnoseanzeigen. Der `XDT-Baukasten` selbst soll diese Legacy-UI nicht benoetigen.
...
Die Haupt-Tabs sind Verarbeitung, Profile & Templates, XDT-Baukasten, Schnittstellenprofile, Sicherung/Umzug und Lizenz. Verarbeitung ist der Betriebsbereich mit Schnittstellen-Monitor, aktiven Schnittstellenprofilen, manuell startbarer Ueberwachung, automatischer Verarbeitung per Haken, Paketstatus und Monitoring-Ereignissen.
