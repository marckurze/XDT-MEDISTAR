...
- NIDEK RT-2100 / RT-3100 / RT-5100 RS232: serielle bidirektionale Phoropterfamilie mit PDF-basierten Type1-/Type2-Presets, gemeinsamem Parser `NidekRtSerialPhoropterParser`, PC->RT-Writer `NidekRtSerialPhoropterOutputWriter`, Kommunikationsservice fuer RS/SD/Senden/Empfangen bis `EOT`, MEDISTAR-Mapping `Final -> 6228` und `Subjective -> 6227`, BuiltIn-Profilen, Schnittstellenprofil-Konfiguration und Templatepaket-Kandidaten; echter RT-3100-Mitschnitt validiert, Produktivpfad `RS senden, dann Writer ohne SD` gesetzt, Rueckgabe nach Sendung und MEDISTAR-Import offen
