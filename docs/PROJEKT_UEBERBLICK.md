...
Wichtig: Diese V2-/BuiltIn-Profile sind vorbereitet und konfigurierbar; TOPCON CL300, TOPCON KR800S, TOPCON TRK2P und TOPCON CT1P sind inzwischen praktisch validiert. Fuer TRK2P ist zusaetzlich die Teilmessungsregel mit einer TM/CCT-only-Datei bestaetigt. TOPCON CT800A ist testseitig als Non-Contact-Tonometer-Kandidat vorbereitet. TOPCON CV5000 ist testseitig als bidirektionaler Kandidat vorbereitet, aber noch nicht live validiert.
