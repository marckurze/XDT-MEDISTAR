...
Fuer rein manuelle Arbeitsablaeufe gibt es zusaetzlich `MEDISTAR + Manuelle Dokumentuebergabe`. AIS startet dabei den Dialog `Dokumente uebertragen` ohne erwartete Geraetedatei; der Anwender fuegt Dateien per Drag-&-Drop oder Dateiauswahl hinzu. Manuell ausgewaehlte Quelldateien werden nicht geloescht.
...
- MEDISTAR + Manuelle Dokumentuebergabe: AIS-gestarteter V1-Kandidat fuer manuell ausgewaehlte Dateien mit Drag-&-Drop/Dateiauswahl, pro-Datei-`6304`, sicherer Copy-Uebergabe und ohne Geraete-Importordner; praktische MEDISTAR-Abnahme offen
- TOPCON CL300
- TOPCON KR800
- TOPCON TRK2P
