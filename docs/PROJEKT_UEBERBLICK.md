...
- `docs/TOMEY_PROTOKOLL_NOTIZEN.md`: Protokollnotizen zur TOMEY-Referenzlogik fuer CF-2000, TL-2000C, TL-6000, TL-7000, MR-6000 und TOP-1000.
- `docs/TEMPLATEPAKET_MEDISTAR_TOMEY_BATCH3.md`: gemeinsame Templatepaket-Dokumentation fuer die sechs TOMEY-Kandidaten mit Export-/Import-Testweg.
