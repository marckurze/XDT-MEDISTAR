...
Wichtig: Diese V2-/BuiltIn-Profile sind vorbereitet und konfigurierbar; TOPCON CL300, TOPCON KR800S und TOPCON TRK2P sind inzwischen praktisch validiert. Fuer TRK2P ist zusaetzlich die Teilmessungsregel mit einer TM/CCT-only-Datei bestaetigt.
...
5. Danach NT530P praktisch in MEDISTAR mit korrigierter `6205`/`6220`-Anzeige und JPG-Mehrfachanhaengen validieren; TOPCON CL300, TOPCON KR800S und TOPCON TRK2P als praktisch validierte Referenzkandidaten beibehalten, H/V-Prisma sowie weitere SBJ-Funktionstestfaelle beobachten.
