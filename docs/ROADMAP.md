...
- `MEDISTAR + TOPCON CL300` ist als erster TOPCON-Lensmeter-Kandidat testseitig vorhanden: echte CL-300-XML-Fixtures mit `nsCommon`/`nsLM`, BuiltIn-Geraeteprofil, Exportprofil, Schnittstellenprofil, `6228`-MedistarLine-Ausgabe mit ADD, PD und signierten H/V-Prismenkomponenten sowie selektiver Templatepaket-Test. Praktische MEDISTAR-Abnahme bleibt offen.
...
- TOPCON CL300: echte XML-Fixtures, BuiltIn-Schnittstellenprofil, `6228`-Lensmeter-Ausgabe und Templatepaket-Kandidat testseitig vorhanden; praktische MEDISTAR-Abnahme offen.
- TOPCON KR800.
- TOPCON TRK2P.
...
- NIDEK NT530P als naechsten praktischen MEDISTAR-Testkandidaten mit korrigiertem `6205`-/`6220`-Layout, JPG-Mehrfachanhaengen und sauberem Ordner-/Karten-Nachlauf erneut abnehmen; TOPCON CL300 anhand der jetzt vorhandenen echten Fixtures praktisch in MEDISTAR testen.
...
- TOPCON CL300 mit dem vorhandenen BuiltIn-Schnittstellenprofil in MEDISTAR praktisch testen: Serial0001 ohne ADD/PD/Prisma und Serial1521 mit ADD, PD und signierten H/V-Prismenkomponenten.
...
7. Danach NIDEK NT530P praktisch in MEDISTAR mit korrigierter `6205`/`6220`-Ausgabe und JPG-Mehrfachanhaengen validieren; TOPCON CL300 mit den beiden echten Fixtures praktisch abnehmen und KR800/TRK2P erst mit belastbaren Beispiel- und Testdaten priorisieren.
