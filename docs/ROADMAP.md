...
- TOPCON CV5000: bidirektionaler Phoropter-Kandidat mit AIS-Historienparser, angebundenem Auswahlfenster `Werte an Phoropter uebergeben`, CV-5000-Import-XML-Writer, Rueckgabeparser, `6228`-Export, BuiltIn-Profilen, Schnittstellenprofil-Konfiguration fuer Ausgabe an Geraet, Templatepaket-Kandidat und Fixture-Protokoll; Rueckweg mit MEDISTAR-Historien-AIS ist abgesichert, finaler MEDISTAR-Import der Rueckgabedatei offen.
...
8. TOPCON CV5000 bidirektional weiter live testen: erzeugte CV-5000-Importdatei am Phoropter einlesen, Phoropter-Rueckgabe ueber `6228` verarbeiten und den finalen MEDISTAR-Import der Rueckgabedatei bestaetigen.
