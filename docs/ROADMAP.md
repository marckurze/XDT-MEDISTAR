...
- NIDEK NT530P als naechsten praktischen MEDISTAR-Testkandidaten mit korrigiertem `6205`-/`6220`-Layout, JPG-Mehrfachanhaengen und sauberem Ordner-/Karten-Nachlauf erneut abnehmen; TOPCON CL300 als praktisch validierten TOPCON-Referenzkandidaten beibehalten und H/V-Prisma weiter beobachten.
...
7. Danach NIDEK NT530P praktisch in MEDISTAR mit korrigierter `6205`/`6220`-Ausgabe und JPG-Mehrfachanhaengen validieren; TOPCON CL300 als validierten Referenzkandidaten beibehalten, H/V-Prisma weiter beobachten und KR800/TRK2P erst mit belastbaren Beispiel- und Testdaten priorisieren.
