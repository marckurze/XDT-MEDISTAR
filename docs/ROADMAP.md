...
- Fuer TOPCON CV5000 / CV-5000S ist als Pilot eine neue grafische Monitoring-Darstellung vorhanden: Geraetebild, linker Infoblock, pulsierende Statuskugel mit gruenem Dateieingangs-Flash und mittige Intervallsteuerung. `Letzter Scan` und `Automatik` sind dort in die Details verschoben; andere Geraete bleiben vorerst unveraendert beim Radar.
