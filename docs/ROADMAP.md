...
- `MEDISTAR + TOPCON CT1P` ist als testseitiger TOPCON-Tono/Pachy-Kandidat vorhanden: echte Serial0214-XML-Fixture mit `nsCommon`/`nsTM`, BuiltIn-Geraeteprofil, Exportprofil, Schnittstellenprofil, `6205` Tonometrie im NT530P/TRK2P-Mehrzeilenformat, `6220` Pachymetrie, einseitige beziehungsweise beidseitige per-eye-CorrectedIOP/CCT-Werte ohne leere Fragmente und selektiver Templatepaket-Test sind vorhanden. Praktische MEDISTAR-Validierung steht noch aus.
...
Praxisprotokolle: `docs/E2E_TESTPROTOKOLL_MEDISTAR_ARK1S_XDT_ANHANG.md`, `docs/E2E_TESTPROTOKOLL_MEDISTAR_AR360.md`, `docs/E2E_TESTPROTOKOLL_MEDISTAR_LM7.md`, `docs/E2E_TESTPROTOKOLL_MEDISTAR_TOPCON_CL300.md`, `docs/E2E_TESTPROTOKOLL_MEDISTAR_TOPCON_KR800S.md`, `docs/E2E_TESTPROTOKOLL_MEDISTAR_TOPCON_TRK2P.md` und `docs/PRAXISABNAHME_GERAETEFENSTER_V1.md`. Die vollstaendige Abarbeitung aller weiteren Testfaelle aus `docs/END_TO_END_TESTPLAN.md` bleibt als separater Schritt offen.
...
- TOPCON CT1P: testseitig vorbereitet mit echter Serial0214-Fixture, `6205` Tono, `6220` Pachy, einseitig verwertbarem CorrectedIOP/CCT und Templatepaket-Kandidat; praktische MEDISTAR-Abnahme offen.
- Fertige, auslieferbare Geraete-Templatepakete als ZIP-Artefakte. Fuer ARK1S, AR360, LM7, NT530P, CL300, KR800S, TRK2P, CT1P und Dokumentanhang sind Referenz- beziehungsweise Kandidatendokumentation und reproduzierbare Export-/Import-Tests bereits vorhanden; dauerhafte ZIPs folgen erst nach `docs/TEMPLATEPAKET_RELEASE_REGEL.md`.
...
- NIDEK NT530P als naechsten praktischen MEDISTAR-Testkandidaten mit korrigiertem `6205`-/`6220`-Layout, JPG-Mehrfachanhaengen und sauberem Ordner-/Karten-Nachlauf erneut abnehmen; TOPCON CL300, TOPCON KR800S und TOPCON TRK2P als praktisch validierte TOPCON-Referenzkandidaten beibehalten, H/V-Prisma beziehungsweise SBJ-Funktionstestfaelle weiter beobachten.
...
7. Danach NIDEK NT530P praktisch in MEDISTAR mit korrigierter `6205`/`6220`-Ausgabe und JPG-Mehrfachanhaengen validieren; TOPCON CL300, TOPCON KR800S und TOPCON TRK2P als validierte Referenzkandidaten beibehalten, H/V-Prisma sowie weitere SBJ-Funktionstestfaelle beobachten.
