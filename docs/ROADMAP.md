...
- Fuer die NIDEK-RT-Phoropterfamilie RT-2100 / RT-3100 / RT-5100 ist ein eigener serieller Parser-/Writer-Zweig vorbereitet: PDF-basierte Presets, SH/SX/EB/ET/CR-Frameauswertung, RT->PC-Parsing fuer Final/Subjective und PC->RT-Vorschau fuer LM-/AR-Daten. Diese Familie bleibt bis zu echten Praxis-Mitschnitten und Live-Abnahme Vorschau-/Teststand.
...
- `MEDISTAR + NIDEK RT-6100` ist als bidirektionaler NIDEK-LAN-/MEM-200-Phoropter-Kandidat testseitig vorbereitet: PDF-Auswertung fuer Shared-Folder-/`DIRECT_RT_xx\TXT`-Ablauf, RT-6100-Inputwriter fuer `LM_Base`/`REF_Base`, Rueckgabeparser fuer `Best` unter `6228` und `Full` unter `6227`, BuiltIn-Geraeteprofil, Exportprofil, Schnittstellenprofil, Ausgabe-an-Geraet-Konfiguration, selektiver Templatepaket-Test und Protokollnotizen sind vorhanden. Das bereitgestellte OCR-XML ist malformed und dient nur als Diagnosefixture; die positive Parserabsicherung nutzt wohlgeformte PDF-nahe Fixtures.
- `MEDISTAR + NIDEK RT-2100/RT-3100/RT-5100 RS232` ist als serielle bidirektionale Phoropterfamilie vorbereitet: Die PDF-Auswertung liefert Type1-/Type2-Presets, gemeinsame SH/SX/EB/ET/CR-Steuerzeichen, RT->PC-Formate fuer Final/Subjective und PC->RT-Sendebloecke fuer LM-/AR-Daten. BuiltIn-Geraete-, Export- und Schnittstellenprofile, selektive Templatepaket-Tests und Baukasten-Geraeteausgabe-Vorschau sind vorhanden. Praktische RS232-Mitschnitte und Live-Senden fehlen bewusst noch.
