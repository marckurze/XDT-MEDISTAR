...
- TOPCON CV5000: bidirektionaler Phoropter-Kandidat mit AIS-Historienparser, angebundenem Auswahlfenster `Werte an Phoropter uebergeben`, CV-5000-Import-XML-Writer, Rueckgabeparser, `6228`-Export, BuiltIn-Profilen, Schnittstellenprofil-Konfiguration fuer Ausgabe an Geraet, Templatepaket-Kandidat und Fixture-Protokoll; praktische MEDISTAR-/CV-5000-Livevalidierung am Geraet offen.
...
8. TOPCON CV5000 bidirektional live testen: im Schnittstellenprofil Ausgabeordner setzen, angebundenes Auswahlfenster historischer MEDISTAR-Messwerte pruefen, CV-5000-Importdatei schreiben lassen und Phoropter-Rueckgabe ueber `6228` verarbeiten.
