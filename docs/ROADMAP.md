...
- TOPCON CV5000: testseitig vorbereiteter bidirektionaler Phoropter-Kandidat mit AIS-Historienparser, CV-5000-Import-XML-Writer, Rueckgabeparser, `6228`-Export, BuiltIn-Profilen, Templatepaket-Kandidat und Fixture-Protokoll; praktische MEDISTAR-/CV-5000-Livevalidierung offen.
...
- TOPCON CV5000 mit dem vorhandenen BuiltIn-Schnittstellenprofil praktisch validieren: AIS-Historienauswahl aus `Patient_mit_Phoropter_Daten.XDT`, Schreiben der CV-5000-Import-XML, Einlesen am Phoropter und Rueckgabe ueber `6228`. Die Fixture-Tests fuer Importwriter und Rueckgabeparser sind vorhanden.
...
8. TOPCON CV5000 bidirektional live testen: Auswahl historischer MEDISTAR-Messwerte, CV-5000-Importdatei und Phoropter-Rueckgabe ueber `6228`.
