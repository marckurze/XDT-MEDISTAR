...
- NIDEK NT530P als naechsten praktischen MEDISTAR-Testkandidaten mit korrigiertem `6205`-/`6220`-Layout, JPG-Mehrfachanhaengen und sauberem Ordner-/Karten-Nachlauf erneut abnehmen; NIDEK Batch 6 XML-Varianten mit echten Praxisrohdateien gegen die vorbereiteten BuiltIns pruefen; TOPCON CL300, TOPCON KR800S, TOPCON TRK2P und TOPCON CT1P als praktisch validierte TOPCON-Referenzkandidaten beibehalten, H/V-Prisma beziehungsweise SBJ-Funktionstestfaelle weiter beobachten; TOPCON Solos, TOPCON KR-1 und TOPCON CT800A praktisch in MEDISTAR abnehmen und echte Transmission-/PDF-, KM/KRT- beziehungsweise weitere Tonometrie-Faelle sammeln; Canon/ZEISS/Visionix Batch 8 inklusive IOLMaster 700 mit echten Praxisrohdateien gegen die synthetischen Fixtures validieren und OCT weiterhin ausklammern; TOPCON CV5000 als ersten bidirektionalen Phoropter-Kandidaten weiter live validieren, insbesondere den MEDISTAR-Import der erzeugten `6228`-/`6227`-Rueckgabe; NIDEK RT6100 am MEM-200/RT-6100 praktisch pruefen und echte wohlgeformte Rueckgaben sammeln.
