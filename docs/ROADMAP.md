...
- NIDEK NT530P als naechsten praktischen MEDISTAR-Testkandidaten mit korrigiertem `6205`-/`6220`-Layout, JPG-Mehrfachanhaengen und sauberem Ordner-/Karten-Nachlauf erneut abnehmen; TOPCON CL300, TOPCON KR800S, TOPCON TRK2P und TOPCON CT1P als praktisch validierte TOPCON-Referenzkandidaten beibehalten, H/V-Prisma beziehungsweise SBJ-Funktionstestfaelle weiter beobachten; TOPCON Solos und TOPCON CT800A praktisch in MEDISTAR abnehmen und echte Transmission-/PDF- beziehungsweise weitere Tonometrie-Faelle sammeln; TOPCON CV5000 als ersten bidirektionalen Phoropter-Kandidaten weiter live validieren, insbesondere den MEDISTAR-Import der erzeugten `6228`-/`6227`-Rueckgabe.
...
7. Danach NIDEK NT530P praktisch in MEDISTAR mit korrigierter `6205`/`6220`-Ausgabe und JPG-Mehrfachanhaengen validieren; TOPCON CL300, TOPCON KR800S, TOPCON TRK2P und TOPCON CT1P als validierte Referenzkandidaten beibehalten, TOPCON Solos und TOPCON CT800A praktisch abnehmen, H/V-Prisma sowie weitere SBJ-/Tonometrie-Funktionstestfaelle beobachten.
