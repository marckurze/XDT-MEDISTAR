...
7. Danach NIDEK NT530P praktisch in MEDISTAR mit korrigierter `6205`/`6220`-Ausgabe und JPG-Mehrfachanhaengen validieren; TOPCON CL300, TOPCON KR800S, TOPCON TRK2P und TOPCON CT1P als validierte Referenzkandidaten beibehalten, TOPCON Solos praktisch abnehmen, H/V-Prisma sowie weitere SBJ-Funktionstestfaelle beobachten.
