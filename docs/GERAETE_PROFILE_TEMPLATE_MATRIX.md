...
- Die Templatepaket-Infrastruktur ist vorhanden und testseitig abgesichert. Fertige, auslieferbare Geraete-Templatepakete als Projektartefakte wurden in der Bestandsaufnahme nicht gefunden.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NIDEK | ARK1S | Autorefraktor | produktiv validiert | `XmlDeviceParser`, ARK1S-Testdatei | BuiltIn `device-nidek-ark1s-default` plus altes Standardprofil | Core-/Pipeline-, DeviceProfile-, ExportProfile-, TemplatePackage-Tests | Infrastruktur vorhanden; fertiges Paket als Datei fehlt | MEDISTAR | validiert fuer externen Link | Validierten Workflow stabil halten und daraus erstes offizielles Templatepaket ableiten | Nicht durch neue Profil-/Templatearbeit regressieren |
...
1. MEDISTAR + NIDEK ARK1S sauber halten: keine Regression am validierten Kernworkflow, erstes offizielles Templatepaket aus vorhandenen BuiltIn-Profilen und Testdaten ableiten.
...
- Fertige Templatepaket-Dateien fehlen noch.
