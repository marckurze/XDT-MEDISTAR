...
| NIDEK | AR360 / AR-360A | Autorefraktor | vorbereitet / beispieldatengetestet | `XmlDeviceParser`, NIDEK-LAN-XML mit ARMedian | BuiltIn `device-nidek-ar360-default` | AR360-Fixtures, UTF-16-Lesetest, MEDISTAR-Ausgabe- und selektive Templatepaket-Tests | Kandidat dokumentiert; selektiver Export ueber `MEDISTAR + NIDEK AR360` testseitig moeglich | MEDISTAR | optional / nicht geraetespezifisch validiert | Praktische App-Abnahme mit echten AR360-Dateien und MEDISTAR-Testimport durchfuehren | Testfixtures wurden aus bereitgestellten Beispielwerten abgeleitet; Live-Praxisabnahme fehlt |
...
2. NIDEK AR360 praktisch abnehmen: testgestuetztes BuiltIn-Profil mit echten AR360-Dateien in der App exportieren/importieren und MEDISTAR-Testimport pruefen.
3. NIDEK LM7/LM7P praktisch nutzbar machen: vorhandene Definitionen mit repraesentativen Dateien validieren und daraus ein fertiges Profil-/Templatepaket erstellen.
...
- Fuer AR360 gibt es Repository-Testfixtures, aber noch kein praktisches MEDISTAR-Abnahmeprotokoll.
- Fuer LM7/LM7P, NT530P und TOPCON fehlen Repository-Testdaten oder praktische Abnahmeprotokolle.
