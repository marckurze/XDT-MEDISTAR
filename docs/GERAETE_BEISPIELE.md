...
| TOPCON | CT800A | Non-Contact-Tonometer | Ophthalmology-/JOIA-XML | `TM`, CorrectedIOP Formula1 | keine zwingend erkennbar | `6205` Tono; CorrectedIOP/CCT nur als `6205`-Detail, wenn vollstaendig | fixture-validierter TOPCON-Tonometrie-Kandidat |
| TOPCON | CV5000 / CV-5000S | Phoropter | Ophthalmology-/JOIA-XML und MEDISTAR-Historien-XDT | `SBJ`, historische `V0`-`V4`-Refraktionszeilen | CV-5000-Import-XML aus Schnittstellenprofil-Konfiguration | Richtung Geraet: XML-Import; Richtung MEDISTAR: `6228` Prescription, `6227` Full Correction; keine `6330`-Zeilen | erster bidirektionaler TOPCON-Kandidat, testseitig vorbereitet |
...
- echte Testfixtures im Repository:
  - `XdtDeviceBridge.Tests/TestData/Devices/Topcon/CL300/M-Serial0001_20120101_000000_TOPCON_CL-300_00.xml`
  - `XdtDeviceBridge.Tests/TestData/Devices/Topcon/CL300/M-Serial1521_20120101_000000_TOPCON_CL-300_00.xml`
...
Measure[@Type='LM']/LM/R/Cylinder
Measure[@Type='LM']/LM/R/Axis
Measure[@Type='LM']/LM/R/Add1
Measure[@Type='LM']/LM/R/H
Measure[@Type='LM']/LM/R/V
Measure[@Type='LM']/PD/B/Distance
...
Erkannte normalisierte SourcePaths:

| Messwert | SourcePath | Beispielwert | Status / Hinweis |
|---|---|---:|---|
| Company | `Common/Company` | `TOPCON` | erkannt |
| ModelName | `Common/ModelName` | `CL-300` | erkannt |
| Measure type LM | `Measure[@Type='LM']/@type` | `LM` | erkannt |
| R Sphere | `Measure[@Type='LM']/LM/R/Sphere` | `+3.75` | erkannt; XML-Wert wird getrimmt |
| R Cylinder | `Measure[@Type='LM']/LM/R/Cylinder` | `-3.50` | erkannt; XML-Wert wird getrimmt |
| R Axis | `Measure[@Type='LM']/LM/R/Axis` | `9` | erkannt; XML-Wert wird getrimmt |
| L Sphere | `Measure[@Type='LM']/LM/L/Sphere` | `+3.50` | erkannt; XML-Wert wird getrimmt |
| L Cylinder | `Measure[@Type='LM']/LM/L/Cylinder` | `-3.00` | erkannt; XML-Wert wird getrimmt |
| L Axis | `Measure[@Type='LM']/LM/L/Axis` | `178` | erkannt |
| PD Distance gesamt | `Measure[@Type='LM']/PD/B/Distance` | `55.0` | erkannt und als `PD= 55` an der rechten Zeile ausgegeben |
| PD Distance rechts | `Measure[@Type='LM']/PD/R/Distance` | `25.0` | erkannt |
| PD Distance links | `Measure[@Type='LM']/PD/L/Distance` | `30.0` | erkannt |

Sonstige relevante Lensmeterwerte:

| Messwert | SourcePath | Beispielwert | Status / Hinweis |
|---|---|---:|---|
| R Addition 1 | `Measure[@Type='LM']/LM/R/Add1` | `+2.25` | erkannt und als `A=+ 2.25` ausgegeben |
| R Addition 2 | `Measure[@Type='LM']/LM/R/Add2` | leer | leer, daher keine Ausgabe |
| R Prisma horizontal | `Measure[@Type='LM']/LM/R/H` | `+0.25` | erkannt und als signierte H-Komponente ausgegeben |
| R Prisma vertikal | `Measure[@Type='LM']/LM/R/V` | `-0.75` | erkannt und als signierte V-Komponente ausgegeben |
| L Addition 1 | `Measure[@Type='LM']/LM/L/Add1` | `+2.25` | erkannt und als `A=+ 2.25` ausgegeben |
| L Addition 2 | `Measure[@Type='LM']/LM/L/Add2` | leer | leer, daher keine Ausgabe |
| L Prisma horizontal | `Measure[@Type='LM']/LM/L/H` | `-0.00` | erkannt, wegen Nullwert nicht ausgegeben |
| L Prisma vertikal | `Measure[@Type='LM']/LM/L/V` | `-1.00` | erkannt und als signierte V-Komponente ausgegeben |
| DiopterStep | `Measure[@Type='LM']/DiopterStep` | `0.25` | erkannt |
| AxisStep | `Measure[@Type='LM']/AxisStep` | `1` | erkannt |
| PrismStep | `Measure[@Type='LM']/PrismStep` | `0.25` | erkannt |
| CylinderMode | `Measure[@Type='LM']/CylinderMode` | `-` | erkannt |
| LensType | `Measure[@Type='LM']/LensType` | `glass` | erkannt |

Erwartete testseitige MEDISTAR-Zeilen:
...
- Namespaces werden über LocalName verarbeitet; Prefixe wie `nsCommon`/`nsLM` sind dadurch nicht hart verdrahtet.
- `Measure` trägt das Attribut `type="LM"` und wird darüber von anderen TOPCON-Messarten unterschieden.
- Werte können führende Leerzeichen enthalten und werden vor Formatierung getrimmt.
...
Geraetetyp: Non-Contact-Tonometer.

Dateiformat:

- XML im TOPCON JOIA-/Ophthalmology-Format, namespace-tolerant gelesen
- erkannte Namespaces: `nsCommon`, `nsTM`
- Root `Ophthalmology`, `Common/Company = TOPCON`, `Common/ModelName = CT-800A`
...
|---|---|---|
| `TM` | Tonometrie / IOP | `6205` |
| `CorrectedIOP/Formula1` | korrigierter IOP / CCT-Kontext | `6205`-Detailzeilen, nur wenn vollstaendig |

Echte Fixtures:

- `XdtDeviceBridge.Tests/TestData/Devices/Topcon/CT800A/M-Serial0069_20190411_170716_TOPCON_CT-800A_AA3100481.xml`
- `XdtDeviceBridge.Tests/TestData/Devices/Topcon/CT800A/M-Serial0070_20190411_171259_TOPCON_CT-800A_AA3100481.xml`
- `XdtDeviceBridge.Tests/TestData/Devices/Topcon/CT800A/M-Serial0071_20190411_175130_TOPCON_CT-800A_AA3100481.xml`

Getestete Ausgaben:

- Serial0069: `6205 PR: 550 [550] um`, `6205 PL: 550 [550] um`, vollstaendige `Gemessen/Korrigiert`- und Parameterzeilen sowie `6205 R = 18 20 [19.0] // L = 17 16 [17.0] mmHg 17:07`
- Serial0070: `6205 R = 18 18 [18.0] // L = 18 19 [19.0] mmHg 17:12`
- Serial0071: `6205 R = 22 22 [22.0] // L = 25 25 24 [25.0] mmHg 17:51`

Hinweise:

- CT-800A wird als eigenes BuiltIn-Geraet `device-topcon-ct800a-default` gefuehrt und nicht als CT-1P-/TRK2P-Alias behandelt.
- Die strukturierten TOPCON-TM-Listen/Average-Werte sind primaere Messquelle.
- Vollstaendige CorrectedIOP/CCT-Daten werden nur je Auge ausgegeben, wenn CCT, Measured und Corrected vorhanden sind.
- Die Fixtures 0070/0071 enthalten unvollstaendige CorrectedIOP-Parameter und ERROR-/Detailbloecke; diese erzeugen keinen Exportabbruch und keine leeren Fragmente.
- Keine `6220`, `6228`, `6221`, `6227`, `6330` oder EV-Zusaetze fuer CT-800A.
- Das BuiltIn-Schnittstellenprofil `MEDISTAR + TOPCON CT800A`, der selektive Templatepaket-Test und das Fixture-Protokoll `docs/E2E_TESTPROTOKOLL_MEDISTAR_TOPCON_CT800A.md` sind vorhanden.

## 8.3 TOPCON CV5000 / CV-5000S
...
- `6330` wird nach praktischem MEDISTAR-Importtest fuer TOPCON CV-5000/CV-5000S nicht mehr verwendet; es gibt keine generische Automatik.
...
| `6304` | sichtbare Beschreibung zur jeweiligen Datei; Benutzertext oder Originaldateiname |
...
- Der pro-Datei-Text wird ueber `6304` uebergeben, nicht als getrennter Sammeltext in `6227`.
- Ohne Benutzertext wird `6304` mit dem Originaldateinamen gefuellt, damit MEDISTAR keinen technischen Pfad als sichtbaren Linktext verwenden muss.
- Mehrzeiliger pro-Datei-Text wird fuer `6304` einzeilig zusammengefuehrt; es entstehen keine nackten Folgezeilen.
