...
- TOPCON CV5000 / CV-5000S als erster bidirektionaler Phoropter-Kandidat: AIS-Historienparser fuer MEDISTAR-Karteikartenzeilen, Auswahlfenster `Werte an Phoropter uebergeben` im Verarbeitungslauf, CV-5000-Import-XML-Writer, CV-5000-Rueckgabeparser, `6228`-Phoropter-Rueckgabe, BuiltIn-Schnittstellenprofil mit Ausgabe-an-Geraet-Konfiguration, selektiver Templatepaket-Test und Fixture-Protokoll sind vorhanden; das Geraeteprofil markiert nur die bidirektionale Faehigkeit, konkrete Ausgabeordner/Dateiname/Format liegen im Schnittstellenprofil. Der Rueckweg liest MEDISTAR-Historien-AIS-Dateien im CV-5000-Kontext tolerant, sodass Karteikartenzeilen den `6228`-Export nicht abbrechen; praktisch offen bleibt der echte MEDISTAR-Import der erzeugten Rueckgabedatei.
...
- praktische MEDISTAR-/CV-5000-Abnahme fuer die bidirektionale Phoropter-Anbindung: erzeugte `CVImport.xml` am CV-5000/CV-5000S weiter beobachten und den finalen MEDISTAR-Import der erzeugten `6228`-Rueckgabedatei pruefen
