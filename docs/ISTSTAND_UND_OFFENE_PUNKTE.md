...
- stabilisierte manuelle Grundlage fuer abdockbare Geraeteanbindungsfenster im Tab `Verarbeitung`: Abdocken/Andocken, sicheres X-Schliessen, Pin, persistentes Positionsmerken, Radar und `-`/`+` pro Schnittstellenprofil
...
| Abdockbare Geraeteanbindungsfenster | UI-Grundlage testseitig fuer State und Persistenz abgesichert | `InterfaceProfileFloatingWindowStateServiceTests`, `InterfaceProfileFloatingWindowStateRepositoryTests` |
