...
| Abdockbare Geraeteanbindungsfenster | UI-Grundlage testseitig fuer State, Persistenz, verzoegerte Wiederherstellung, Auto-Abdocken, Auto-Zurueckandocken, akustisches Signal nur bei Geraetedatei-Eingang und Systray-Fensterzustand abgesichert | `InterfaceProfileFloatingWindowStateServiceTests`, `InterfaceProfileFloatingWindowStateRepositoryTests`, `InterfaceProfileFloatingWindowRestoreGateTests`, `InterfaceProfileAutoDetachServiceTests`, `InterfaceProfileAutoRedockServiceTests`, `InterfaceProfileNotificationSoundServiceTests`, `TrayWindowStateServiceTests` |
