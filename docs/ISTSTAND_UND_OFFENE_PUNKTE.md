...
- TOPCON CL300 als erster TOPCON-Lensmeter-Kandidat mit echten XML-Fixtures, namespace-toleranter LM-Erkennung, `6228`-MedistarLine-Ausgabe inklusive ADD, PD und signierten H/V-Prismenkomponenten, BuiltIn-Schnittstellenprofil und selektivem Templatepaket-Test
...
- V2-Geraeteprofile fuer TOPCON KR800 und TOPCON TRK2P
...
- TOPCON CL300: echte XML-Fixtures, `6228`-Lensmeter-Ausgabe und Templatepaket-Kandidat testseitig vorhanden; praktische MEDISTAR-Abnahme offen
- TOPCON KR800
- TOPCON TRK2P
...
| hoch | Fertige Geraeteprofile und Templatepakete | BuiltIn-Geraeteprofile und MEDISTAR-Exportprofile sind fuer neun Geraete beziehungsweise Workflows vorhanden; praktisch validiert sind MEDISTAR + NIDEK ARK1S, die AR360-Auto-Refraktor-XDT-Rueckgabe und die LM7-Lensmeter-XDT-Rueckgabe. NT530P und TOPCON CL300 sind testseitig mit echten XML-Fixtures, korrigierten beziehungsweise berechneten MEDISTAR-Ausgaben und selektiven Templatepaket-Kandidaten direkt nutzbar. Matrix, Referenz-/Kandidatendokumentation, selektiver Export, reproduzierbare Export-/Import-Tests und stabilisierter App-Preview-Pfad sind vorhanden. | Dauerhafte ARK1S-/AR360-/LM7-ZIP-Release-Artefakte, AR360-XDT-Anhangfall und weitere LM7-Prisma-/PD-Faelle fehlen; fuer NT530P und TOPCON CL300 fehlt die praktische MEDISTAR-Abnahme. | Release-Regel fuer ARK1S/AR360 anwenden, LM7-Prisma-/PD-Beispielfaelle sammeln, NT530P in MEDISTAR praktisch mit `6220`/`6205` sowie JPG-Mehrfachanhaengen abnehmen und TOPCON CL300 mit Serial0001/Serial1521 testen. | Anwender muessen sonst weiterhin den Baukasten nutzen. | BuiltIn-Profile, TemplatePackageExporter, Testdaten |
...
| mittel | TOPCON CL300 produktiv validieren | Echte Serial0001-/Serial1521-XML-Fixtures, Namespace-/LM-Erkennung, BuiltIn-Geraete-/Export-/Schnittstellenprofil, `6228`-MedistarLine-Ausgabe mit ADD, PD und signierten H/V-Prismenkomponenten sowie Templatepaket-Kandidat sind testseitig vorhanden. | Praktische MEDISTAR-Abnahme der Karteikartenanzeige fehlt. | CL300-Live-Test mit Serial0001 und Serial1521 durchfuehren und protokollieren. | MEDISTAR-Anzeige der H/V-Prismenkomponenten koennte fachlich nachjustiert werden muessen. | Testdaten, MEDISTAR-Anforderungen |
...
- NT530P
- TOPCON CL300 praktisch in MEDISTAR abnehmen
- TOPCON KR800
- TOPCON TRK2P
