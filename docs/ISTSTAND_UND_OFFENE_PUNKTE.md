...
- TOPCON KR800S als testseitig direkt nutzbarer Mehruntersuchungs-Kandidat mit echten Shift-JIS-XML-Fixtures, namespace-toleranter REF/KM/SBJ-Erkennung, `6228`-Autorefraktion, `6221`-Keratometrie, konservativer `6227`-SBJ-Ausgabe, BuiltIn-Schnittstellenprofil, selektivem Templatepaket-Test und gezielter Reparatur alter persistierter BuiltIn-Exportprofile
...
- TOPCON KR800S: echte Shift-JIS-XML-Fixtures, REF-`6228`, KM-`6221`, konservative SBJ-`6227`-Ausgabe und Templatepaket-Kandidat testseitig vorhanden; praktische MEDISTAR-Abnahme offen
- TOPCON TRK2P
...
| mittel | TOPCON KR800S produktiv validieren | Echte Shift-JIS-Fixtures, namespace-tolerante REF/KM/SBJ-Erkennung, `6228`/`6221`/`6227`-Export, BuiltIns, Templatepaket-Test und Repair alter persistierter BuiltIn-Exportregeln sind vorhanden. | Praktische MEDISTAR-Abnahme nach dem Live-Fix fehlt. | KR800S mit Serial0036/Serial0426 in MEDISTAR testen und SBJ-Darstellung fachlich bewerten. | Subjektive `6227`-Zeilen koennten nach Praxisfeedback feiner formuliert werden. | Testdaten, MEDISTAR-Anforderungen |
