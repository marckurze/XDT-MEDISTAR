...
- Aktivierungsassistent fuer importierte Schnittstellenprofile; erste read-only Backend-Bewertung, UI-Pruefvorschau und vorbereitende Aktivierungsvorschau im Tab `Schnittstellenprofile` sind vorhanden, inklusive strukturierter Ordner- und XDT-Anhang-Detailanzeige; produktive Aktivierung bleibt offen
