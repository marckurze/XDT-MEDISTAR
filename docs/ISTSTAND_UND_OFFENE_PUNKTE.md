...
- TOPCON TRK2P als testseitig vollstaendiger Mehruntersuchungs-Kandidat mit echten XML-Fixtures inklusive TM/CCT-only-Teilmessung, namespace-toleranter REF/KM/TM/CCT-Erkennung, `6228`-Autorefraktion, `6221`-Keratometrie, `6220`-CCT/Pachy mit Header, mehrzeiliger `6205`-Tonometrie im NT530P-Stil, optionalem `6227`-SBJ-Pfad, BuiltIn-Schnittstellenprofil, selektivem Templatepaket-Test und gezielter Reparatur alter persistierter BuiltIn-Profile
...
- TOPCON TRK2P: testseitiger Kandidat mit echten Serial0001-/Serial0135-/Serial1165-Fixtures, REF/KM/TM/CCT-Fallback, TM/CCT-only-Teilmessung und Templatepaket-Kandidat; praktische MEDISTAR-Abnahme offen
...
| hoch | Fertige Geraeteprofile und Templatepakete | BuiltIn-Geraeteprofile und MEDISTAR-Exportprofile sind fuer neun Geraete beziehungsweise Workflows vorhanden; praktisch validiert sind MEDISTAR + NIDEK ARK1S, die AR360-Auto-Refraktor-XDT-Rueckgabe, die LM7-Lensmeter-XDT-Rueckgabe, TOPCON CL300 und TOPCON KR800S. NT530P ist testseitig mit echter XML-Fixture, korrigierter MEDISTAR-Ausgabe und selektivem Templatepaket-Kandidaten direkt nutzbar. Matrix, Referenz-/Kandidatendokumentation, selektiver Export, reproduzierbare Export-/Import-Tests und stabilisierter App-Preview-Pfad sind vorhanden. | Dauerhafte ARK1S-/AR360-/LM7-/CL300-/KR800S-ZIP-Release-Artefakte, AR360-XDT-Anhangfall, weitere LM7-Prisma-/PD-Faelle und die praktische NT530P-Abnahme fehlen. Fuer CL300 bleibt die H/V-Prisma-Darstellung weiter zu beobachten; fuer KR800S bleiben weitere SBJ-/Funktionstestfaelle zu beobachten. | Release-Regel fuer ARK1S/AR360 anwenden, LM7-Prisma-/PD-Beispielfaelle sammeln, NT530P in MEDISTAR praktisch mit `6220`/`6205` sowie JPG-Mehrfachanhaengen abnehmen und CL300-/KR800S-Praxisprotokolle als Referenz halten. | Anwender muessen sonst weiterhin den Baukasten nutzen. | BuiltIn-Profile, TemplatePackageExporter, Testdaten |
...
| mittel | TOPCON TRK2P produktiv validieren | Echte Serial0001-/Serial0135-/Serial1165-Fixtures, namespace-tolerante REF/KM/TM-Erkennung, CCT-Fallback aus CorrectedIOP und TM/CCT-only-Teilimport, `6228`/`6221`/`6220`/`6205`-Export mit `Tonometrie`-/`Pachymetrie`-Headern und mehrzeiliger `6205`-Anzeige, BuiltIns, Repair alter persistierter BuiltIns und Templatepaket-Test sind vorhanden. | Praktische MEDISTAR-Abnahme fehlt; SBJ ist in den aktuellen Fixtures nicht enthalten. | TRK2P mit allen drei XML-Dateien in MEDISTAR testen und die Teilmessungs- sowie mehrzeilige `6205`-/`6220`-Anzeige protokollieren. | IOP/CCT-Anzeige koennte fachlich nachjustiert werden muessen. | Testdaten |
