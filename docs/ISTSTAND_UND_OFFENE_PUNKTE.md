...
- Reset-/Duplikatsperren arbeiten dateiversionsbezogen: Eine neu geschriebene Datei mit gleichem Namen wird anhand geaenderter Dateiversion wieder erkannt. Beim CV-5000 gilt das auch fuer die haeufig gleich benannte AIS-Datei `Patient.gdt`; identische AIS-/Geraetepaare bleiben gegen Doppelexport gesperrt, erzeugen nach erfolgreichem Export aber keinen zusaetzlichen Fehlernachlauf.
