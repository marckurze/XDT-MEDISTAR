...
- TOPCON CV5000 / CV-5000S als erster bidirektionaler Phoropter-Kandidat: AIS-Historienparser fuer MEDISTAR-Karteikartenzeilen, Auswahlfenster `Werte an Phoropter uebergeben` im Verarbeitungslauf, CV-5000-Import-XML-Writer, CV-5000-Rueckgabeparser, fachlich getrennte Rueckgabe (`Prescription` mit `6227`-Header und `6228`-Werten, `Full Correction` mit `6227`-Header und CV-5000-spezifischen `6330`-Werten), BuiltIn-Schnittstellenprofil mit Ausgabe-an-Geraet-Konfiguration, selektiver Templatepaket-Test und Fixture-Protokoll sind vorhanden; das Geraeteprofil markiert nur die bidirektionale Faehigkeit, konkrete Ausgabeordner/Dateiname/Format liegen im Schnittstellenprofil. Der Rueckweg liest MEDISTAR-Historien-AIS-Dateien im CV-5000-Kontext tolerant; praktisch offen bleibt der echte MEDISTAR-Import der erzeugten Rueckgabedatei.
...
- praktische MEDISTAR-/CV-5000-Abnahme fuer die bidirektionale Phoropter-Anbindung: erzeugte `CVImport.xml` am CV-5000/CV-5000S weiter beobachten und den finalen MEDISTAR-Import der Rueckgabedatei mit `6228`-Prescription und `6330`-Full-Correction pruefen
...
| hoch | Fertige Geraeteprofile und Templatepakete | BuiltIn-Geraeteprofile und MEDISTAR-Exportprofile sind fuer zehn Geraete beziehungsweise Workflows vorhanden; praktisch validiert sind MEDISTAR + NIDEK ARK1S, die AR360-Auto-Refraktor-XDT-Rueckgabe, die LM7-Lensmeter-XDT-Rueckgabe, TOPCON CL300, TOPCON KR800S, TOPCON TRK2P inklusive TM/CCT-only-Teilmessung und TOPCON CT1P. NT530P ist testseitig mit echter XML-Fixture, korrigierter MEDISTAR-Ausgabe und selektivem Templatepaket-Kandidaten direkt nutzbar. Matrix, Referenz-/Kandidatendokumentation, selektiver Export, reproduzierbare Export-/Import-Tests und stabilisierter App-Preview-Pfad sind vorhanden. | Dauerhafte ARK1S-/AR360-/LM7-/CL300-/KR800S-/TRK2P-/CT1P-ZIP-Release-Artefakte, AR360-XDT-Anhangfall, weitere LM7-Prisma-/PD-Faelle und die praktische NT530P-Abnahme fehlen. Fuer CL300 bleibt die H/V-Prisma-Darstellung weiter zu beobachten; fuer KR800S/TRK2P bleiben weitere SBJ-/Funktionstestfaelle zu beobachten; fuer CT1P fehlt eine echte beidseitige CorrectedIOP/CCT-Fixture. | Release-Regel fuer ARK1S/AR360 anwenden, LM7-Prisma-/PD-Beispielfaelle sammeln, NT530P in MEDISTAR praktisch mit `6220`/`6205` abnehmen und CL300-/KR800S-/TRK2P-/CT1P-Praxisprotokolle als Referenz halten. | Anwender muessen sonst weiterhin den Baukasten nutzen. | BuiltIn-Profile, TemplatePackageExporter, Testdaten |
...
- NIDEK NT530P als naechsten praktischen MEDISTAR-Testkandidaten mit korrigiertem `6205`/`6220`-Layout und optionalem JPG-Mehrfachanhang abnehmen; TOPCON CT1P als validierten `6205`/`6220`-Referenzkandidaten halten; TOPCON CL300, KR800S und TRK2P als validierte Referenzkandidaten halten.
