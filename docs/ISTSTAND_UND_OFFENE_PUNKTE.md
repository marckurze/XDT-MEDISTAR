...
- TOPCON KR800S als testseitig direkt nutzbarer Mehruntersuchungs-Kandidat mit echten Shift-JIS-XML-Fixtures, namespace-toleranter REF/KM/SBJ-Erkennung, `6228`-Autorefraktion, `6221`-Keratometrie, konservativer `6227`-SBJ-Ausgabe mit getrennten Header-/Messwertzeilen, BuiltIn-Schnittstellenprofil, selektivem Templatepaket-Test und gezielter Reparatur alter persistierter BuiltIn-Exportprofile
...
- V2-Geraeteprofil fuer TOPCON TRK2P; TOPCON KR800S ist testseitig angebunden, aber praktisch in MEDISTAR noch nicht abgenommen
...
- TOPCON KR800S: echte Shift-JIS-XML-Fixtures, REF-`6228`, KM-`6221`, konservative SBJ-`6227`-Ausgabe mit getrennten Full-Correction-Header-/Messwertzeilen und Templatepaket-Kandidat testseitig vorhanden; praktische MEDISTAR-Abnahme offen
- TOPCON TRK2P
...
| hoch | Fertige Geraeteprofile und Templatepakete | BuiltIn-Geraeteprofile und MEDISTAR-Exportprofile sind fuer neun Geraete beziehungsweise Workflows vorhanden; praktisch validiert sind MEDISTAR + NIDEK ARK1S, die AR360-Auto-Refraktor-XDT-Rueckgabe, die LM7-Lensmeter-XDT-Rueckgabe und TOPCON CL300 als erster TOPCON-Referenzkandidat. NT530P ist testseitig mit echter XML-Fixture, korrigierter MEDISTAR-Ausgabe und selektivem Templatepaket-Kandidaten direkt nutzbar. Matrix, Referenz-/Kandidatendokumentation, selektiver Export, reproduzierbare Export-/Import-Tests und stabilisierter App-Preview-Pfad sind vorhanden. | Dauerhafte ARK1S-/AR360-/LM7-/CL300-ZIP-Release-Artefakte, AR360-XDT-Anhangfall, weitere LM7-Prisma-/PD-Faelle und die praktische NT530P-Abnahme fehlen. Fuer CL300 bleibt die H/V-Prisma-Darstellung weiter zu beobachten. | Release-Regel fuer ARK1S/AR360 anwenden, LM7-Prisma-/PD-Beispielfaelle sammeln, NT530P in MEDISTAR praktisch mit `6220`/`6205` sowie JPG-Mehrfachanhaengen abnehmen und CL300-Praxisprotokoll als Referenz halten. | Anwender muessen sonst weiterhin den Baukasten nutzen. | BuiltIn-Profile, TemplatePackageExporter, Testdaten |
...
| mittel | TOPCON KR800S produktiv validieren | Echte Shift-JIS-Fixtures, namespace-tolerante REF/KM/SBJ-Erkennung, `6228`/`6221`/`6227`-Export, getrennte SBJ-Header-/Messwertzeilen, BuiltIns, Templatepaket-Test und Repair alter persistierter BuiltIn-Exportregeln sind vorhanden. | Praktische MEDISTAR-Abnahme nach dem Live-Fix fehlt. | KR800S mit Serial0036/Serial0426 in MEDISTAR testen und SBJ-Darstellung fachlich bewerten. | Subjektive `6227`-Zeilen koennten nach Praxisfeedback feiner formuliert werden. | Testdaten, MEDISTAR-Anforderungen |
...
- TOPCON KR800S praktisch in MEDISTAR validieren
- TOPCON TRK2P
