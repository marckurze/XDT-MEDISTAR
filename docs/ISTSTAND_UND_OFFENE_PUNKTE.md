...
- grafischer Pilot fuer TOPCON CV5000 / CV-5000S im Geraetefenster und in der Monitoring-Karte: Geraetebild, linker Infoblock, pulsierende Statuskugel mit gruenem Dateieingangs-Flash, mittige Intervallsteuerung und `Letzter Scan`/`Automatik` im Detailbereich; andere Geraetefenster bleiben bewusst beim Radar. Neue UserDefined-Geraete koennen optional einen einfachen Geraetebildpfad speichern.
