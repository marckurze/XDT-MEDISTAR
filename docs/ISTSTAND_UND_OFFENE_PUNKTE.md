...
- Steckbrief-Folgeschritt: Der Steckbrief-Button muss noch in die passende Profil-/Geraete-UI integriert werden. Ausserdem soll der Profil-/Templateexport spaeter lokale Steckbrief-Overrides fuer das betroffene Geraeteprofil mitnehmen; aktuell ist diese Abgrenzung dokumentiert, waehrend Sicherung/Umzug bereits unterstuetzt wird.
