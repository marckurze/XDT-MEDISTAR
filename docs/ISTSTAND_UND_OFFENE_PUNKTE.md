...
- TOPCON CV5000 / CV-5000S als erster bidirektionaler Phoropter-Kandidat: AIS-Historienparser fuer MEDISTAR-Karteikartenzeilen, CV-5000-Import-XML-Writer, CV-5000-Rueckgabeparser, `6228`-Phoropter-Rueckgabe, BuiltIn-Schnittstellenprofil mit Ausgabe-an-Geraet-Konfiguration, selektiver Templatepaket-Test und Fixture-Protokoll sind vorhanden; das Geraeteprofil markiert nur die bidirektionale Faehigkeit, konkrete Ausgabeordner/Dateiname/Format liegen im Schnittstellenprofil, und die praktische MEDISTAR-/CV-5000-Livevalidierung steht noch aus.
...
- praktische MEDISTAR-/CV-5000-Abnahme fuer die bidirektionale Phoropter-Anbindung: Auswahl historischer Datensaetze, im Schnittstellenprofil gesetzten Ausgabeordner nutzen, Import-XML schreiben, Einlesen am CV-5000/CV-5000S und Rueckgabe ueber `6228`
