...
- erste manuelle Grundlage fuer abdockbare Geraeteanbindungsfenster im Tab `Verarbeitung`: Abdocken/Andocken, Pin und Positionsmerken pro Schnittstellenprofil als UI-Zustand
...
- Systray-Betrieb, automatisches Abdocken bei Dateiempfang, automatisches Zurueckdocken und persistente Fensterpositionen fuer abdockbare Geraeteanbindungen
...
| Abdockbare Geraeteanbindungsfenster | erste UI-Grundlage testseitig fuer State abgesichert | `InterfaceProfileFloatingWindowStateServiceTests` |
...
| mittel | Abdockbare Geraeteanbindungsfenster | Manuelles Abdocken/Andocken, Pin und Positionsmerken fuer die aktuelle Sitzung sind als UI-Grundlage vorhanden. | Systray, Auto-Popup bei Dateieingang, Auto-Zurueckdocken, Rueckdock-Zeit und Neustart-Persistenz fehlen bewusst. | Praktisch mit AR360/ARK1S testen und danach Auto-Popup separat planen. | Ohne Auto-Popup muss der Benutzer noch manuell abdocken. | Verarbeitungstab, Monitoring-Karten |
