...
- praktische MEDISTAR-/CV-5000-Abnahme fuer die bidirektionale Phoropter-Anbindung: erzeugte `CVImport.xml` am CV-5000/CV-5000S weiter beobachten, den Pfad `Nichts senden` im echten Ablauf pruefen und den finalen MEDISTAR-Import der Rueckgabedatei mit `6228`-Prescription und `6330`-Full-Correction pruefen
