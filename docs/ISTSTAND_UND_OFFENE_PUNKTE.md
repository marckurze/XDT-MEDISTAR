...
- Aktivierungsassistent fuer importierte Schnittstellenprofile; erste read-only Backend-Bewertung und eine UI-Pruefvorschau im Tab `Schnittstellenprofile` sind vorhanden, produktive Aktivierung bleibt offen
