...
- TOPCON CT1P als testseitiger Tonometrie-/Pachymetrie-Kandidat mit echter Serial0214-XML-Fixture, namespace-toleranter TM-Erkennung, mehrzeiliger `6205`-Tonometrie, `6220`-Pachymetrie, per Auge optionalem CorrectedIOP/CCT, BuiltIn-Schnittstellenprofil und selektivem Templatepaket-Test; das Geraet misst fachlich vollautomatisch beidseitig, unvollstaendige CorrectedIOP-Bloecke in einer XML werden aber ohne leere Fragmente weggelassen.
...
- fertige, auslieferbare ZIP-Templatepakete fuer vorbereitete und validierte Geraeteprofile; fuer ARK1S, AR360, LM7, CL300, KR800S, TRK2P und CT1P sind Referenz-/Kandidatendokumentation und temporaer erzeugte Export-/Import-Tests vorhanden, offizielle ZIP-Artefakte folgen erst nach Release-Regel
...
- TOPCON CT1P: echte Serial0214-Fixture, Tonometrie `6205`, Pachymetrie `6220`, per Auge optionales CorrectedIOP/CCT, BuiltIns und Templatepaket-Kandidat testseitig vorhanden; praktische MEDISTAR-Abnahme offen
...
| hoch | Fertige Geraeteprofile und Templatepakete | BuiltIn-Geraeteprofile und MEDISTAR-Exportprofile sind fuer zehn Geraete beziehungsweise Workflows vorhanden; praktisch validiert sind MEDISTAR + NIDEK ARK1S, die AR360-Auto-Refraktor-XDT-Rueckgabe, die LM7-Lensmeter-XDT-Rueckgabe, TOPCON CL300, TOPCON KR800S und TOPCON TRK2P inklusive TM/CCT-only-Teilmessung. NT530P und TOPCON CT1P sind testseitig mit echter XML-Fixture, korrigierter MEDISTAR-Ausgabe und selektivem Templatepaket-Kandidaten direkt nutzbar. Matrix, Referenz-/Kandidatendokumentation, selektiver Export, reproduzierbare Export-/Import-Tests und stabilisierter App-Preview-Pfad sind vorhanden. | Dauerhafte ARK1S-/AR360-/LM7-/CL300-/KR800S-/TRK2P-/CT1P-ZIP-Release-Artefakte, AR360-XDT-Anhangfall, weitere LM7-Prisma-/PD-Faelle und die praktische NT530P-/CT1P-Abnahme fehlen. Fuer CL300 bleibt die H/V-Prisma-Darstellung weiter zu beobachten; fuer KR800S/TRK2P bleiben weitere SBJ-/Funktionstestfaelle zu beobachten. | Release-Regel fuer ARK1S/AR360 anwenden, LM7-Prisma-/PD-Beispielfaelle sammeln, NT530P und CT1P in MEDISTAR praktisch mit `6220`/`6205` abnehmen und CL300-/KR800S-/TRK2P-Praxisprotokolle als Referenz halten. | Anwender muessen sonst weiterhin den Baukasten nutzen. | BuiltIn-Profile, TemplatePackageExporter, Testdaten |
...
| mittel | TOPCON CT1P produktiv validieren | Echte Serial0214-Fixture, namespace-tolerante TM-Erkennung, `6205`-Tonometrie, `6220`-Pachymetrie, per Auge optionales CorrectedIOP/CCT, BuiltIns und Templatepaket-Test sind vorhanden. | Praktische MEDISTAR-Abnahme und weitere Datei mit vollstaendigem linkem CorrectedIOP/CCT fehlen. | CT1P live mit AIS-Untersuchungsart testen; falls eine Datei mit vollstaendigen rechten und linken CorrectedIOP-/CCT-Werten vorliegt, als zweite Fixture ergaenzen. | MEDISTAR-Darstellung oder Herstellerdateien mit vollstaendig anderem Partialmuster koennten Nachjustierung erfordern. | Testdaten |
...
- NIDEK NT530P als naechsten praktischen MEDISTAR-Testkandidaten mit korrigiertem `6205`/`6220`-Layout und optionalem JPG-Mehrfachanhang abnehmen; TOPCON CT1P mit `6205`/`6220` praktisch testen; TOPCON CL300, KR800S und TRK2P als validierte Referenzkandidaten halten.
...
- TOPCON CT1P mit vollautomatischer beidseitiger Tonometrie/Pachymetrie praktisch in MEDISTAR validieren
