...
- Die grafische Hersteller-App `XdtBox.LicenseManager.exe` heisst sichtbar `XDTBox Lizenzmanager`, besitzt eine eigene Version `1.0` und liest Lizenzanfragen, erzeugt signierte `.xdtboxlic`-Dateien, fuehrt eine lokale Historie ausgestellter Lizenzen und speichert Hersteller-Einstellungen. Sie ist nicht Teil der Endkunden-App; private Schluessel bleiben externe Dateien.
