...
public sealed class InterfaceProfileManualProcessor : IInterfaceProfileManualProcessor
{
    ...
    private static bool UsesShinNipponParser(
        InterfaceProfileDefinition interfaceProfile,
        ExportProfileDefinition exportProfile)
    {
        return IsShinNipponId(interfaceProfile.DeviceProfileId)
    ...
    private static bool UsesCanonZeissVisionixParser(
        InterfaceProfileDefinition interfaceProfile,
        ExportProfileDefinition exportProfile)
    {
        return IsCanonZeissVisionixId(interfaceProfile.DeviceProfileId)
    ...
    private static bool IsShinNipponId(string? value)
    {
        return !string.IsNullOrWhiteSpace(value)
    ...
    private static bool IsCanonZeissVisionixId(string? value)
    {
        return !string.IsNullOrWhiteSpace(value)
