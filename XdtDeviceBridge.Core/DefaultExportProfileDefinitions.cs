        ...
        return new ExportProfileDefinition(
            ...
            Rules: new[]
            {
                ...
                new ExportRuleDefinition(
                    ...
                    14,
                    true,
                    "MEDISTAR tonometry line with CorrectedIOP and IOP list for TOPCON TRK-2P when available."),
                new ExportRuleDefinition(
                    "15",
                    "6205",
                    "TonometryList",
                    ...
                    15,
                    true,
                    "MEDISTAR tonometry list line for TOPCON TRK-2P when no CorrectedIOP is available."),
                new ExportRuleDefinition(
                    "16",
                    "6227",
                    "SubjectiveRefractionLine1",
