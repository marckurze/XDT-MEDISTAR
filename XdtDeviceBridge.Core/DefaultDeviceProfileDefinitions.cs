    ...
    public static DeviceProfileDefinition CreateNidekNt530PDefault()
    {
        ...
        return new DeviceProfileDefinition(
            ...
            Measurements: new[]
            {
                ...
                new DeviceMeasurementDefinition("nt530p-tono-medistar-line", "MEDISTAR Tonometrie-Zeile", "Measure[@Type='NT530P']/Tono/MedistarLine", "NT", string.Empty, string.Empty, true, "Computed MEDISTAR tonometry line for field 6205; empty optional fragments are omitted.")
            },
