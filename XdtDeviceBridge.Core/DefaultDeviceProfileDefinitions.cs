    ...
    public static DeviceProfileDefinition CreateTopconCv5000Default()
    {
        ...
        return new DeviceProfileDefinition(
            Metadata: new ProfileMetadata(
                ...
                ProfileKind: ProfileKind.DeviceProfile,
                Description: "Default device profile definition for bidirectional TOPCON CV-5000 / CV-5000S phoropter workflows. Incoming SBJ XML is read namespace-tolerantly: Prescription is returned with 6228 values and Full Correction with CV-5000-specific 6330 values; AIS history can be written as TOPCON CV-5000 XML import candidate.",
                Vendor: "TOPCON",
            ...
            Measurements: new[]
            {
                ...
                new DeviceMeasurementDefinition("cv5000-prescription-header", "Prescription MEDISTAR-Header", "Measure[@Type='SBJ']/Prescription/HeaderLine", "SBJ", string.Empty, string.Empty, false, "Computed MEDISTAR 6227 header for TOPCON CV-5000 Prescription."),
                ...
                new DeviceMeasurementDefinition("cv5000-full-correction-r-line", "Full Correction R MEDISTAR-Zeile", "Measure[@Type='SBJ']/FullCorrection/R/MedistarLine", "SBJ", "R", string.Empty, false, "Computed MEDISTAR 6330 right-eye line for TOPCON CV-5000 Full Correction."),
                new DeviceMeasurementDefinition("cv5000-full-correction-l-line", "Full Correction L MEDISTAR-Zeile", "Measure[@Type='SBJ']/FullCorrection/L/MedistarLine", "SBJ", "L", string.Empty, false, "Computed MEDISTAR 6330 left-eye line for TOPCON CV-5000 Full Correction.")
            },
