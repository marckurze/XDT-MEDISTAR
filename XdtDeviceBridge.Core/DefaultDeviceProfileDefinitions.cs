    ...
    public static DeviceProfileDefinition CreateTopconKr800Default()
    {
        ...
        return new DeviceProfileDefinition(
            ...
            Measurements: new[]
            {
                ...
                new DeviceMeasurementDefinition("kr800-ref-r-se", "REF R SE", "Measure[@Type='REF']/REF/R/Median/SE", "REF", "R", "dpt", false, "Right spherical equivalent from TOPCON KR-800S REF median values."),
                new DeviceMeasurementDefinition("kr800-ref-l-se", "REF L SE", "Measure[@Type='REF']/REF/L/Median/SE", "REF", "L", "dpt", false, "Left spherical equivalent from TOPCON KR-800S REF median values."),
                ...
                new DeviceMeasurementDefinition("kr800-ref-pd-near", "REF PD Near", "Measure[@Type='REF']/PD/Near", "REF", string.Empty, "mm", false, "Binocular near PD from TOPCON KR-800S REF block."),
                ...
                new DeviceMeasurementDefinition("kr800-ref-r-medistar-line-va", "REF R MEDISTAR-Zeile mit Visus", "Measure[@Type='REF']/REF/R/MedistarLineWithVisualAcuity", "REF", "R", string.Empty, false, "Computed MEDISTAR REF line with FAR visual acuity from TOPCON KR-800S SBJ values."),
                new DeviceMeasurementDefinition("kr800-ref-l-medistar-line-va", "REF L MEDISTAR-Zeile mit Visus", "Measure[@Type='REF']/REF/L/MedistarLineWithVisualAcuity", "REF", "L", string.Empty, false, "Computed MEDISTAR REF line with FAR visual acuity from TOPCON KR-800S SBJ values."),
                ...
                new DeviceMeasurementDefinition("kr800-sbj-type1-name", "SBJ Type 1 Name", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/TypeName", "SBJ", string.Empty, string.Empty, false, "Subjective refraction type name from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-far-distance", "SBJ FAR Distance", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='1']/Distance", "SBJ", string.Empty, "cm", false, "Subjective Full Correction FAR distance from TOPCON KR-800S."),
                ...
                new DeviceMeasurementDefinition("kr800-sbj-far-r-cylinder", "SBJ FAR R Cylinder", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='1']/RefractionData/R/Cyl", "SBJ", "R", "dpt", false, "Subjective Full Correction FAR right cylinder from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-far-r-axis", "SBJ FAR R Axis", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='1']/RefractionData/R/Axis", "SBJ", "R", "deg", false, "Subjective Full Correction FAR right axis from TOPCON KR-800S."),
                ...
                new DeviceMeasurementDefinition("kr800-sbj-far-l-cylinder", "SBJ FAR L Cylinder", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='1']/RefractionData/L/Cyl", "SBJ", "L", "dpt", false, "Subjective Full Correction FAR left cylinder from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-far-l-axis", "SBJ FAR L Axis", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='1']/RefractionData/L/Axis", "SBJ", "L", "deg", false, "Subjective Full Correction FAR left axis from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-far-vd", "SBJ FAR VD", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='1']/RefractionData/VD", "SBJ", string.Empty, "mm", false, "Subjective Full Correction FAR vertex distance from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-far-va-r", "SBJ FAR R VA", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='1']/VA/R", "SBJ", "R", string.Empty, false, "Subjective Full Correction FAR right visual acuity from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-far-va-l", "SBJ FAR L VA", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='1']/VA/L", "SBJ", "L", string.Empty, false, "Subjective Full Correction FAR left visual acuity from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-pd-b", "SBJ FAR PD B", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='1']/PD/B", "SBJ", string.Empty, "mm", false, "Subjective Full Correction FAR binocular PD."),
                new DeviceMeasurementDefinition("kr800-sbj-near-distance", "SBJ NEAR Distance", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/Distance", "SBJ", string.Empty, "cm", false, "Subjective Full Correction NEAR distance from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-near-r-sphere", "SBJ NEAR R Sphere", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/RefractionData/R/Sph", "SBJ", "R", "dpt", false, "Subjective Full Correction NEAR right sphere from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-near-r-cylinder", "SBJ NEAR R Cylinder", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/RefractionData/R/Cyl", "SBJ", "R", "dpt", false, "Subjective Full Correction NEAR right cylinder from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-near-r-axis", "SBJ NEAR R Axis", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/RefractionData/R/Axis", "SBJ", "R", "deg", false, "Subjective Full Correction NEAR right axis from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-near-l-sphere", "SBJ NEAR L Sphere", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/RefractionData/L/Sph", "SBJ", "L", "dpt", false, "Subjective Full Correction NEAR left sphere from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-near-l-cylinder", "SBJ NEAR L Cylinder", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/RefractionData/L/Cyl", "SBJ", "L", "dpt", false, "Subjective Full Correction NEAR left cylinder from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-near-l-axis", "SBJ NEAR L Axis", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/RefractionData/L/Axis", "SBJ", "L", "deg", false, "Subjective Full Correction NEAR left axis from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-near-vd", "SBJ NEAR VD", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/RefractionData/VD", "SBJ", string.Empty, "mm", false, "Subjective Full Correction NEAR vertex distance from TOPCON KR-800S."),
                new DeviceMeasurementDefinition("kr800-sbj-near-va-r", "SBJ NEAR R VA", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/VA/R", "SBJ", "R", string.Empty, false, "Subjective Full Correction NEAR right visual acuity from TOPCON KR-800S, when present."),
                new DeviceMeasurementDefinition("kr800-sbj-near-va-l", "SBJ NEAR L VA", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/VA/L", "SBJ", "L", string.Empty, false, "Subjective Full Correction NEAR left visual acuity from TOPCON KR-800S, when present."),
                new DeviceMeasurementDefinition("kr800-sbj-near-pd-b", "SBJ NEAR PD B", "Measure[@Type='SBJ']/RefractionTest/Type[@No='1']/ExamDistance[@No='2']/PD/B", "SBJ", string.Empty, "mm", false, "Subjective Full Correction NEAR binocular PD."),
